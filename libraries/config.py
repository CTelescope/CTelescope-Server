...
SIDERAL_SPEED_IN_SPS = {
    "AD" :((( 360 / (360/MOTOR_SPR)) * MICRO_STEP_MODE * AXE_AD_GEAR_REDUC * AD_EQ_M_GEAR_REDUC) / SIDERAL_DAY_IN_SEC),
    "DEC":((( 360 / (360/MOTOR_SPR)) * MICRO_STEP_MODE * AXE_DEC_GEAR_REDUC * DEC_EQ_M_GEAR_REDUC) / SIDERAL_DAY_IN_SEC),
}