...
from libraries.control import do_steps, goto, get_position, set_speed, get_speed, get_sideral_speed_spms
...
def init_routes_tls (app):
    ...
    #--------------------------------------------------------
    # Permet de recuperer la vitesse sideral en step/ms du télescope.
    @app.route("/api/control/sideral_speed_spms",methods=['GET'])
    def GetSideralSpeedSPMS():
        return jsonify(get_sideral_speed_spms())
